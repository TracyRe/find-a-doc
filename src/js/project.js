export class DoctorList {
  ...
  getDoctors(search) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      let url = `https://api.betterdoctor.com/2016-03-01/doctors?${search}&location=45.523%2C-122.676%2C100&user_location=45.523%2C-122.676&sort=distance-asc&skip=0&limit=50&user_key=${process.env.exports.apiKey}`;
